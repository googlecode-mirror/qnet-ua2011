...
if ($header->isOwnProfile()) {
    ...
    echo '<li><a id="photo"/><form enctype="multipart/form-data" action="../controller/photoController.php?actionId=1" method="POST">
<input type="hidden" name="MAX_FILE_SIZE" value="100000" />
Choose a file to upload: <input name="uploadedfile" type="file" /><br />';
    if ($_GET[photoUpload] == "wrong") {
        echo "<div style='color:red'>Error Upload Photo (invalid Ext or the file is too big) </div>";
    }
